...
describe('stopContainer', () => {
  ...
  it('accepts valid container names with dots and underscores', () => {
    expect(() => stopContainer('nanoclaw.test_123')).not.toThrow();
    expect(() => stopContainer('nanoclaw-a')).not.toThrow();
  });
});
