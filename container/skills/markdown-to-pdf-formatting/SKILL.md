---
name: markdown-to-pdf-formatting
description: Convert Markdown files to clean, well-formatted PDFs using pandoc + Chromium headless. Handles tables, custom HTML widgets, and full-page-width rendering.
allowed-tools: Bash(*)
---
